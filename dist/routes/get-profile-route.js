...
var get_profile_route_exports = {};
__export(get_profile_route_exports, {
  getProfileRoute: () => getProfileRoute
});
module.exports = __toCommonJS(get_profile_route_exports);
      ...
      schema: {
        ...
        response: {
          200: import_zod2.default.object({
            profile: import_zod2.default.object({
              id: import_zod2.default.string(),
              name: import_zod2.default.string().nullable(),
              email: import_zod2.default.string().nullable(),
              avatarUrl: import_zod2.default.string().url()
            })
          })
        }
      }
