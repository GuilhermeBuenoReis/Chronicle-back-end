...
var get_task_route_exports = {};
__export(get_task_route_exports, {
  getTaskRoute: () => getTaskRoute
});
module.exports = __toCommonJS(get_task_route_exports);
...
async function getTasks({ userId }) {
  ...
  }).from(tasks).where((0, import_drizzle_orm.eq)(tasks.userId, userId));
  if (!result) {
