...
var authenticate_user_route_exports = {};
__export(authenticate_user_route_exports, {
  AuthenticateUserRoute: () => AuthenticateUserRoute
});
module.exports = __toCommonJS(authenticate_user_route_exports);
  ...
  app.post(
    "/auth/authenticate",
    {
      schema: {
        ...
        response: {
          201: import_zod2.default.object({ token: import_zod2.default.string() })
        }
      }
    },
    async (request, reply) => {
