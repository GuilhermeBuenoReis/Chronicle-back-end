...
var delete_task_by_id_route_exports = {};
__export(delete_task_by_id_route_exports, {
  deleteTaskByIdRoute: () => deleteTaskByIdRoute
});
module.exports = __toCommonJS(delete_task_by_id_route_exports);
...
async function deleteTaskById({ taskId }) {
  const result = await db.delete(tasks).where((0, import_drizzle_orm.eq)(tasks.id, taskId));
  return {
    result
  };
}
