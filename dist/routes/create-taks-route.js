...
var create_taks_route_exports = {};
__export(create_taks_route_exports, {
  createTaskRoute: () => createTaskRoute
});
module.exports = __toCommonJS(create_taks_route_exports);
    ...
    "/task",
    {
      schema: {
        ...
        body: import_zod2.z.object({
          ...
          is_completed: import_zod2.z.boolean()
        }),
        response: {
