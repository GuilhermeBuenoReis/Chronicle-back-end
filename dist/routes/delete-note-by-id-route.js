...
var delete_note_by_id_route_exports = {};
__export(delete_note_by_id_route_exports, {
  deleteNoteByIdRoute: () => deleteNoteByIdRoute
});
module.exports = __toCommonJS(delete_note_by_id_route_exports);
...
async function deleteNoteById({ noteId }) {
  const result = await db.delete(notes).where((0, import_drizzle_orm.eq)(notes.id, noteId));
  return {
    result
  };
}
