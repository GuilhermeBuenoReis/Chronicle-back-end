...
var get_notes_route_exports = {};
__export(get_notes_route_exports, {
  getNotesRoute: () => getNotesRoute
});
module.exports = __toCommonJS(get_notes_route_exports);
...
async function getNotes({ userId }) {
  ...
  }).from(notes).where((0, import_drizzle_orm.eq)(notes.userId, userId));
  if (!result) {
