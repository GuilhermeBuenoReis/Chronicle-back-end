...
var get_pending_goals_router_exports = {};
__export(get_pending_goals_router_exports, {
  getWeekPendingGoalsRoute: () => getWeekPendingGoalsRoute
});
module.exports = __toCommonJS(get_pending_goals_router_exports);
...
async function getWeekPendingGoals({
  ...
  const pendingGoals = await db.with(goalsCreatedUpToWeek, goalCompletionsCount).select({
    ...
    (0, import_drizzle_orm.eq)(goalCompletionsCount.goalId, goalsCreatedUpToWeek.id)
  );
  return {
    pendingGoals
  };
      ...
      schema: {
        ...
        response: {
          200: import_zod2.default.object({
            pendingGoals: import_zod2.default.array(
              import_zod2.default.object({
                id: import_zod2.default.string(),
                title: import_zod2.default.string(),
                desiredWeeklyFrequency: import_zod2.default.number(),
                completionCount: import_zod2.default.number()
              })
            )
          })
        }
