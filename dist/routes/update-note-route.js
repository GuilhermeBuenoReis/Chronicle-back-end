...
var update_note_route_exports = {};
__export(update_note_route_exports, {
  updatedNoteRoute: () => updatedNoteRoute
});
module.exports = __toCommonJS(update_note_route_exports);
...
async function updateNoteById({
  ...
  const result = await db.update(notes).set({
    ...
    content,
    tags
  }).where((0, import_drizzle_orm.eq)(notes.id, noteId)).returning();
    ...
    "/notes/update/:id",
    {
      schema: {
        ...
        body: import_zod2.default.object({
          ...
          tags: import_zod2.default.string().optional()
        }),
        response: {
          201: import_zod2.default.object({
            updatedNote: import_zod2.default.object({
              id: import_zod2.default.string(),
              title: import_zod2.default.string(),
              content: import_zod2.default.string(),
              tags: import_zod2.default.string().nullable(),
