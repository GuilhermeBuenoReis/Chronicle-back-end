...
var find_note_by_id_route_exports = {};
__export(find_note_by_id_route_exports, {
  findNotesByIdRoute: () => findNotesByIdRoute
});
module.exports = __toCommonJS(find_note_by_id_route_exports);
      ...
      schema: {
        ...
        response: {
          200: import_zod2.default.object({
            note: import_zod2.default.object({
              id: import_zod2.default.string(),
