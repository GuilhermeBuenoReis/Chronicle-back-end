...
// src/functions/create-user.spec.ts
...
// src/functions/create-user.spec.ts
(0, import_vitest.describe)("create user", () => {
  (0, import_vitest.it)("shoud be able to create a new user", async () => {
    ...
    (0, import_vitest.expect)(result).toEqual({
      user: import_vitest.expect.objectContaining({
        id: import_vitest.expect.any(String),
        name: "Guilherme",
        email: "email@test.com",
        password: "123456",
        avatarUrl: import_vitest.expect.any(String)
      })
    });
  });
});
