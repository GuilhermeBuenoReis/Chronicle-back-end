...
__export(gamification_exports, {
  calculateExperienceForNextLevel: () => calculateExperienceForNextLevel,
  calculateLevelFromExperience: () => calculateLevelFromExperience
});
module.exports = __toCommonJS(gamification_exports);
